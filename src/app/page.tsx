  ...
  return (
    <>
      ...
      <section id="hero" className="relative overflow-hidden px-6 py-24 sm:py-32 lg:py-40">
        ...
        {/* HeroCarousel manages its own width — sits OUTSIDE the max-w-4xl wrapper so it can expand wider when a slide is clicked. */}
        <HeroCarousel />
        ...
        <div className="mx-auto mt-10 flex max-w-4xl flex-col items-center gap-4 text-center">
          ...
          <p className="text-sm text-muted-dim">or install via command line:</p>
      ...
      <section className="border-t border-white/5 bg-deep-forest px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-center text-base text-muted">
            Your LLM like Claude Code or OpenAI Codex gets the full sequence
            — not a fragment. Your narration travels with the screenshot it
            describes. The ask is explicit. The AI can act.
          </p>
        </div>
      </section>

        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <a
              ...
              className="text-xl font-semibold text-teal underline decoration-teal/40 underline-offset-4 transition hover:text-teal-light hover:decoration-teal-light/60"
            >
              Or download the .dmg directly &darr;
            </a>
